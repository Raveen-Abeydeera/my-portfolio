      ...
      <section id="projects" className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50/50 dark:bg-black/20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Project 4: Wildroute PWA */}
            <Reveal className="bg-white dark:bg-card-dark rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform duration-300 group">
              {/* Replace 'main-thumbnail.png' with your actual file name */}
              <img src="/images/wildroute/main-thumbnail.png" alt="Wildroute PWA" className="w-full h-48 object-cover" />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-text-light dark:text-text-dark mb-2">Wildroute PWA</h3>
                <p className="text-muted-light dark:text-muted-dark text-sm mb-4">MERN Stack Progressive Web App with interactive maps.</p>
                <Link to="/project/wildroute" className="inline-flex items-center text-accent-primary hover:text-accent-hover font-medium">
                  View Details <ArrowRight className="ml-1 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </Reveal>

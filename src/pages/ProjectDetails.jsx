...
export default function ProjectDetails({ title, desc, repoLink, downloadLink, liveLink, techStack, features, screenshots, children }) {
    return (
        <div className="min-h-screen pt-20 pb-12 px-6 max-w-7xl mx-auto">
            ...
            <div className="mb-12">
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                    {liveLink && (
                        <a href={liveLink} target="_blank" rel="noopener noreferrer" className="bg-accent-primary text-white px-6 py-3 rounded-lg font-bold hover:bg-accent-hover transition flex items-center shadow-lg shadow-accent-primary/20">
